...
export const Teacher_home = ({ route }) => {
      ...
      <LinearGradient
        ...
        <View style={styles.buttonContainer}>
          <Animatable.View animation="fadeInLeft" delay={500} duration={1000}>
            <TouchableOpacity
              style={styles.button}
              onPress={() => navigation.navigate('Tprofile', { userEmail: userEmail })}>
              <View style={{ margin: 10 }}>
                <Image
                  ...
                  source={require('../src/assets/pf.png')}
                />
              </View>
          ...
          <Animatable.View animation="fadeInRight" delay={700} duration={1000}>
            <TouchableOpacity
              style={styles.button}
              onPress={() => navigation.navigate('Settest', { userEmail: userEmail })}>
              <View style={{ margin: 10 }}>
                <Image
                  style={{
                    width: 70,
                  ...
                  source={require('../src/assets/settest.png')}
                />
              </View>
              <Text style={styles.buttonText}>Set test</Text>
            </TouchableOpacity>
          </Animatable.View>
          <Animatable.View animation="fadeInLeft" delay={900} duration={1000}>
            <TouchableOpacity
              style={styles.button}
              onPress={() => navigation.navigate('Tresult_list', { userEmail: userEmail })}>
              <View style={{ margin: 10 }}>
                <Image
                  style={{
                    width: 70,
          ...
          <Animatable.View animation="fadeInRight" delay={1100} duration={1000}>
            <TouchableOpacity
              style={styles.button}
              onPress={() => navigation.navigate('Tannouncement')}>
              <View style={{ margin: 10 }}>
                <Image
                  style={{
                    width: 70,
